...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "student_distilled_quantized_static"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xd6bfd17ec1303af82d7dc9bf6d0d74e6"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xd6d2f9bde7dc0b2e)
...
#define STAI_NETWORK_MACC_NUM            (54201177)

/*  Macros to declare input buffers characteristics  */
#define STAI_NETWORK_IN_NUM              (1)
#define STAI_NETWORK_IN_SIZE_BYTES       (12296)
...
#define STAI_NETWORK_IN_1_SIZE_BYTES  (12289)
...
#define STAI_NETWORK_OUT_SIZE_BYTES      (4100)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,64,1,64}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (64)
#define STAI_NETWORK_OUT_1_HEIGHT      (1)
#define STAI_NETWORK_OUT_1_WIDTH       (64)
#define STAI_NETWORK_OUT_1_RANK        (3)
#define STAI_NETWORK_OUT_1_SIZE        ((64 * 1 * 64))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (4096)
#define STAI_NETWORK_OUT_1_SCALE       (0.00392156932502985f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-128)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (151260)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (151260)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (20188)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (20188)
#define STAI_NETWORK_ACTIVATION_1_ALIGNMENT  4
#define STAI_NETWORK_ACTIVATION_2_FLAGS      (STAI_FLAG_ACTIVATIONS)
#define STAI_NETWORK_ACTIVATION_2_SIZE       (131072)
#define STAI_NETWORK_ACTIVATION_2_SIZE_BYTES (131072)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (488388)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (488388)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (488388)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (488388)
